class DropLetter {
  constructor(thisLetter, sizer, thisX, thisY){
    this.nowSize = sizer;
  ...
  textPointMaker(){
    this.points = tFont[fontSelect].textToPoints(this.thisLetter, this.orgX, this.orgY, this.nowSize, {
      sampleFactor: 0.1,
      simplifyThreshold: 0
    });
  }
  ...
  physicsPointMaker(){
    ...
    var newY = this.orgY - this.nowSize * pgTextFactor[fontSelect]/2;
    ...
    this.bodyLetter = Bodies.fromVertices(newX, newY, this.points, options);
