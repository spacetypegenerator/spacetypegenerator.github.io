...
function setup() {
  ...
  bkgdColorPicker = createColorPicker('#000');bkgdColorPicker.position(152, 235);bkgdColorPicker.style('height', '50px');
...
function draw() {
  ...
  push();
  rotate(-PI/2);
  text("SEGMENT TOGGLES AND COLORS",-215,144);
  text("BKGD COLORS", -290,144);
  pop();
    }
